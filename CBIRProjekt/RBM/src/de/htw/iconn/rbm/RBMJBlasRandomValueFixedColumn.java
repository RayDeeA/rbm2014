...
public class RBMJBlasRandomValueFixedColumn implements IRBM {
    ...
    public RBMJBlasRandomValueFixedColumn(int numVisbible, int numHidden, double learningRate, double[][] weights, ILogistic sigmoid, int randomFactorEachXEpoch) {
	...
	public RBMJBlasRandomValueFixedColumn(int numVisbible, int numHidden, double learningRate, ILogistic sigmoid, int randomFactorEachXEpoch) {
		this.learningRate = learningRate;
		this.sigmoid = sigmoid;
		this.randomFactorEachXEpoch = randomFactorEachXEpoch;
	    ...
	    for (int i = 0; i < max_epochs; i++) {
	    	...
	    	if(i % randomFactorEachXEpoch == 0) {
	    		...
	    		for(int r = 0; r < this.weights.getRows(); r++) {
	    			...
	    			this.weights.put(r, col, randomValue);
	    		}
