...
public class RBMJBlasRandomValueVariablePosition implements IRBM {
    ...
    public RBMJBlasRandomValueVariablePosition(int numVisbible, int numHidden, double learningRate, double[][] weights, ILogistic sigmoid, int randomFactorEachXEpoch) {
	...
	public RBMJBlasRandomValueVariablePosition(int numVisbible, int numHidden, double learningRate, ILogistic sigmoid, int randomFactorEachXEpoch) {
		this.learningRate = learningRate;
		this.sigmoid = sigmoid;
		this.randomFactorEachXEpoch = randomFactorEachXEpoch;
...
//		Printer.printMatrix("JBLAS DataWithBias", dataWithBias);
	    ...
	    for (int i = 0; i < max_epochs; i++) {
	    	...
	    	if(i % randomFactorEachXEpoch == 0) {
	    		int randomRow = Random.nextInt(this.weights.getRows());
	    		int randomColumn = Random.nextInt(this.weights.getColumns());
