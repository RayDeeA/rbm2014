...
public class RBMJBlasNicoTest extends TestCase{
    ...
    public void testFunctionEndTrainingEnhancement(){
       ...
       tempNicoweights = nicoRBM.getWeights();
        
       
       IRBM jblasRBM = new RBMJBlas(numVisible, numHidden, learningRate, new DefaultLogisticMatrixFunction(), true, 0, tempNicoweights);
       ...
       errorOrigin = nicoRBM.error(trainingData, true, true);  
