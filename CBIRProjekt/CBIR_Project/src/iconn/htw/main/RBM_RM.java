...
public class RBM_RM implements IRBM {
    ...
    public RBM_RM(int numVisbible, int numHidden, double learningRate, double[][] weights) {
	...
	public RBM_RM(int numVisbible, int numHidden, double learningRate) {
		this.numHidden = numHidden;
		this.numVisible = numVisbible;
		this.numHiddenWithBias = numHidden + 1;
		this.numVisibleWithBias = numVisbible + 1;
