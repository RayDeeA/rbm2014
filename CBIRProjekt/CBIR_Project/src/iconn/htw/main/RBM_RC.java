...
public class RBM_RC implements IRBM {
    ...
    public RBM_RC(int numVisbible, int numHidden, double learningRate, double[][] weights) {
	...
	public RBM_RC(int numVisbible, int numHidden, double learningRate) {
		this.numHidden = numHidden;
		this.numVisible = numVisbible;
		this.numHiddenWithBias = numHidden + 1;
		this.numVisibleWithBias = numVisbible + 1;
