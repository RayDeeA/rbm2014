...
public class RBM_SR implements IRBM {
    ...
    public RBM_SR(int numVisbible, int numHidden, double learningRate, double[][] weights) {
	...
	public RBM_SR(int numVisbible, int numHidden, double learningRate) {
		this.numHidden = numHidden;
		this.numVisible = numVisbible;
		this.numHiddenWithBias = numHidden + 1;
		this.numVisibleWithBias = numVisbible + 1;
