...
public class RBM_CJ implements IRBM {
    ...
    public RBM_CJ(int numVisbible, int numHidden, double learningRate, double[][] weights) {
	...
	public RBM_CJ(int numVisbible, int numHidden, double learningRate) {
		this.numHidden = numHidden;
		this.numVisible = numVisbible;
		this.numHiddenWithBias = numHidden + 1;
		this.numVisibleWithBias = numVisbible + 1;
