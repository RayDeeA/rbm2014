...
public class RBM_GA implements IRBM {
    ...
    public RBM_GA(int numVisbible, int numHidden, double learningRate, double[][] weights) {
	...
	public RBM_GA(int numVisbible, int numHidden, double learningRate) {
		this.numHidden = numHidden;
		this.numVisible = numVisbible;
		this.numHiddenWithBias = numHidden + 1;
		this.numVisibleWithBias = numVisbible + 1;
