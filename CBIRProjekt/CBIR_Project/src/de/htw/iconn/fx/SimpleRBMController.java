...
public class SimpleRBMController implements Initializable, IFXController {
	...
	private void initializeTrainingErrorView() {
		...
		try {
			...
			this.errorStage.setY(imageViewer.getY() + imageViewer.getHeight());
			this.errorStage.setX(imageViewer.getX());
			this.errorStage.setWidth(imageViewer.getWidth());
