...
public class Sorter_RGBInterpolation extends Sorter {

	
	
	public Sorter_RGBInterpolation(Pic[] pics, Settings settings, ForkJoinPool pool) {
	...
	public double getDistance(double[] fv1, double[] fv2) {
		return ColorMetric.getGeneticSolutionDistance(fv1, fv2);
	}
